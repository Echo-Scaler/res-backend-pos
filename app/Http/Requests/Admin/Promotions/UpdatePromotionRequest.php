...
class UpdatePromotionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $promotionId = $this->route('promotion') instanceof Promotion
            ? $this->route('promotion')->id
        ...
        return [
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique('promotions', 'code')->ignore($promotionId)->where(function ($query) use ($currentUser) {
